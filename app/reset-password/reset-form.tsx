...
export default function ResetPasswordForm() {
  ...
  if (!canReset) {
    return (
      <div className="w-full max-w-md mx-auto p-8 bg-white rounded-2xl shadow-lg border border-muted-200 text-center text-muted-800">
  ...
  return (
    <div className="w-full max-w-md mx-auto p-8 bg-white rounded-2xl shadow-lg border border-muted-200">
      <h2 className="text-3xl font-extrabold mb-6 text-center text-primary-900 tracking-tight">Definir nova senha</h2>
